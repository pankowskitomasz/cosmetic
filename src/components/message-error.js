            ...
            <Container fluid className={"contact-form align-items-center p-0 py-5 d-flex minh-50vh " + this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    <Col xs={10} md={6} className="mx-auto p-0 d-flex align-items-center">
                        <Card className="mx-auto bg-light border-success shadow">
                            <Card.Header className="text-white bg-success text-start border-success">
                                Message error!
                            </Card.Header>
                            <Card.Body className="text-center text-success p-5">
                                <p className="lead">Message was not sent!</p>
                                <Button variant={"outline-success rounded-pill"} onClick={this.hndBack.bind(this)}>
                                    back to Form
                                </Button>
                            </Card.Body>
                        </Card>
