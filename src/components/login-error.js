            ...
            <Container fluid className={"login-form align-items-center p-0 py-5 bg-white d-flex minh-footer-adj " + this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    <Col xs={10} md={6} className="mx-auto p-0 d-flex align-items-center">
                        <Card className="mx-auto border border-success rounded bg-form shadow text-success">
                            <Card.Header className="text-success fw-bold text-start border-success">
                                Login error!
                            </Card.Header>
                            <Card.Body className="text-center text-success p-5">
                                <p className="lead">Incorrect login or password!</p>
                                <Button variant={"outline-success"} onClick={this.hndBack.bind(this)}>
                                    OK
                                </Button>
                            </Card.Body>
                        </Card>
